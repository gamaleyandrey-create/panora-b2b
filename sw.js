...
const CORE=[
  ...
  './retail/index.html',
  './retail/manifest.webmanifest','./','index.html','retail.html','retail-order.html','admin.html','confirm.html','confirm.js','confirm.css','confirm-close.css','icon.svg','icon-192.png','icon-512.png','apple-touch-icon.png','bread-plain.jpg','bread-pumpkin.jpg','styles.css','portal.css','admin.css','app.js','portal.js','admin.js','supabase-config.js','audit-log.js','cloud-sync.js','admin-auth.js','admin-localization.js','admin-mobile-tabs.js','admin-status-sync.js','account-detail.js','accounting-invoice.js','spanish-documents.js','calendar-plan.js','checkout-flow-fix.js','commerce.js','daily-order-summary.js','delivery-offline.js','delivery-followup.js','delivery-qr.js','document-library.js','dynamic-products.js','input-stability.js','install-guide.js','invoice-close.js','invoice-preview.js','invoice-settings.js','invoice-tax-display.js','mobile-admin-nav.js','order-communication.js','order-notifications.js','portal-cloud.js','product-admin.js','purchase-costs.js','qrcode-browser.js','recipe-percent.js','restaurant-workspace.js','account-detail.css','account-documents.css','account-state.css','accounting-invoice.css','admin-auth.css','admin-mobile-tabs.css','admin-order-polish.css','bakery-orders-consolidated.css','admin-v247.css','bake-info.css','calendar-bake-highlight.css','calendar-calm.css','calendar-fun.css','calendar-labels.css','calendar-plan.css','calendar-text-restore.css','calendar-weekend.css','cart-date.css','checkout-feedback.css','commerce.css','daily-order-summary.css','daily-selection.css','date-jump.css','delivery-offline.css','delivery-followup.css','delivery-qr.css','document-library.css','easy-plan.css','export.css','first-order.css','install-guide.css','invoice-preview.css','mobile-admin-all.css','mobile-admin-menu.css','mobile-admin-nav-fix.css','mobile-admin-orders.css','mobile-buttons.css','mobile-cart-button.css','mobile-cart-flex.css','mobile-cart-layout.css','mobile-catalog.css','mobile-checkout-stable.css','mobile-checkout.css','mobile-nav-icons.css','order-notifications.css','order-prices.css','product-admin.css','product-close.css','purchase-costs.css','purchase-filter-simple.css','purchase-filter.css','quantity.css','recipe-actions.css','recipe-percent.css','reminder-hours.css','responsive.css','restaurant-workspace.css','settings.css','unified-controls.css','desktop-order-date-filter-v28.js','notifications-v39.css','pricing-v40.css','stable-price-inputs-v42.js','price-inputs-v42.css','money-edit-lock-v43.js','pricing-sync-v44.js','public-catalog-cloud-v48.js','retail-account.js','retail-account.css','mobile-partner-prices-v49.css','partner-mobile-consolidated.css','admin-partner-prices-direct-v426.js','admin-partner-prices-guard-v426.js','pwa-stable.js','connection-status.js','order-messages-v565.js','order-messages-v565.css','admin-partner-theme.css','audit-trail.css','audit-trail.js','connection-status.css','event-notifications.css','event-notifications.js','finance-dashboard.css','finance-dashboard.js','production-safety.css','production-safety.js','quality-compliance-v1075.css','quality-compliance-v1075.js','light-pro.css','mobile-header.css','mobile-partner-v20.css','pwa-stable.css','recovery-guard.js','stable-health.js'];
...
self.addEventListener('activate',event=>event.waitUntil((async()=>{for(const key of await caches.keys())if(key.startsWith('panora-v')&&key!==CACHE)await caches.delete(key);await self.clients.claim()})()));
...
const PANORA_PUSH_DB='panora-push-quiet-root-v1',PANORA_PUSH_STORE='pending';
...
async function panoraShowPush(data){return self.registration.showNotification(String(data.title||'Panora'),{body:String(data.body||'Panora'),icon:'icon-192.png',badge:'icon-192.png',tag:String(data.tag||data.notification_id||'panora-retail'),renotify:true,data:{url:panoraPushTarget(data)}})}

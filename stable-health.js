/* Panora 9.75 — production runtime health. */
(function(){
 async function run(){
   const out={build:'9750',online:navigator.onLine,serviceWorker:'serviceWorker' in navigator,fetch:typeof fetch==='function',storage:false};

...
const navButtons=new Map(['ps-production','ps-bread-lots','ps-raw-lots','ps-allergens','ps-sanitation','ps-documents','ps-trace','ps-help'].map(x=>[x,{textContent:''}]));
...
console.log('Panora 10.70 help runtime handlers: OK');

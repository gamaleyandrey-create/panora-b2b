...
function partnerOrderQuantityLimit(id,currentQty=0){const live=catalogAvailablePieces(id),current=Math.max(0,Math.floor(Number(currentQty)||0));return account?Math.min(MAX_PIECES_PER_PRODUCT,Math.max(50,live,current)):live}

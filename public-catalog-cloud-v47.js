/* Panora 4.7 — public retail catalogue cloud.
...
(()=>{
 ...
 async function fetchCatalog(){
  ...
  loading=(async()=>{
   ...
   const before=localStorage.getItem('panora-products')||'[]';
   const after=JSON.stringify(next);
   if(before!==after){
    localStorage.setItem('panora-products',after);
    window.dispatchEvent(new CustomEvent('panora:products-changed',{detail:{source:'public-retail-cloud'}}));

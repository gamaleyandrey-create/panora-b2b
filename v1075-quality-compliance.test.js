...
assert.deepEqual(build,{version:'11.13',build:11130,cache:11130});
...
console.log('Panora 11.13 persistent label tools + rich editor + confirmable print warnings: OK');

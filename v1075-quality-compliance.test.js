...
assert.deepEqual(build,{version:'11.15',build:11150,cache:11150});
...
console.log('Panora 11.15 exact label size + collapsible editor + image brand: OK');

...
assert.deepEqual(build,{version:'11.14',build:11140,cache:11140});
...
for(const token of ['58 × 40 мм · ценник','70 × 50 мм · компактно','100 × 50 мм','100 × 70 мм · рекомендовано','58 × 160 мм · вертикальная'])assert.ok(productAdmin1113.includes(token),`size retained/added: ${token}`);
...
console.log('Panora 11.14 direct label editor + stable Done + confirmable print warnings: OK');

...
const orderCountsForHeader=()=>{
  // Panora 10.29: shipped orders cannot be classified until delivery notes / receipt
...
const orderReceiptFinalized=o=>{
  ...
  // Panora 10.29: use the same durable receipt evidence as the delivery-note archive.
  ...
  if(o?.deliveryConfirmedAt)return true;
  const note=orderDeliveryNote(o);

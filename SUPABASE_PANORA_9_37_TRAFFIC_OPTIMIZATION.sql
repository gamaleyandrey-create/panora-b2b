-- Panora 9.37 — Traffic Optimization VII
-- Run once in Supabase SQL Editor after publishing Panora 9.37.
...
-- Return shape changed in 9.37, so recreate explicitly.
...
comment on function public.panora_admin_commerce_revision() is 'Panora 9.37: component commerce revisions plus authoritative order counters.';
comment on function public.panora_partner_commerce_revision() is 'Panora 9.37: partner-scoped component commerce revisions.';
comment on function public.panora_admin_finance_expense_revision() is 'Panora 9.37: lightweight gate that prevents unchanged finance expense downloads.';
comment on function public.panora_admin_operational_revision() is 'Panora 9.37: component revisions for plan, raw stock and factual bake completion.';

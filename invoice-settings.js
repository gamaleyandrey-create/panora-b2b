const invoiceDefaults={notePrefix:'DN-',nextNoteNumber:1,noteTitle:'Накладная',paymentTerms:'',noteFooter:'',bakerySignature:'Panora',customerSignature:'Ресторан',useTax:false,showTax:false};

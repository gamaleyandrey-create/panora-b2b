(()=>{
  ...
  async function hydrate(){
    ...
    account=own;localStorage.setItem('panora-account-id',own.id);applyAccount();if(typeof refreshRestaurantData==='function')refreshRestaurantData();setCloudState('ok',lang==='ru'?'Соединение установлено':lang==='es'?'Conexión establecida':'Connected');return true;
  }

-- Panora 9.54 — Traffic Optimization X
-- Run once in Supabase SQL Editor after publishing Panora 9.54.
...
comment on function public.panora_admin_reference_revision() is
  'Panora 9.54: one lightweight revision gate for products, partners/prices, recipes and raw-material prices.';

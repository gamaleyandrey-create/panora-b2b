-- Panora 9.47 — Traffic Optimization X
-- Run once in Supabase SQL Editor after publishing Panora 9.47.
...
comment on function public.panora_admin_reference_revision() is
  'Panora 9.47: one lightweight revision gate for products, partners/prices, recipes and raw-material prices.';

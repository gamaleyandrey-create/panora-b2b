/* Panora 10.02 — installed PWA role/scope migration helper */
(function(){
  const BUILD='10020';
  ...
  window.addEventListener('DOMContentLoaded',()=>{
    ...
    box.innerHTML=`<div class="panora-pwa-name-card"><strong>Panora 10.02</strong><p>Эта роль работает как отдельное приложение: <b>${expected}</b>. У Партнёра, Пекарни и Розницы теперь собственные адрес, manifest и service worker.</p><div><button type="button" data-pwa-name-ok>Понятно</button></div></div>`;
